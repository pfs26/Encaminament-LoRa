/*
  Exemple bàsic de funcionament capa sleep.
    Es configura el callback d'obtenció de dades, així com el dispositiu veí
    a qui propagar les dades i sincronització.
*/
