...
% // TODO: Afegir figura de la topologia

Aquesta topologia pot ser útil en entorns agrícoles, on els sensors es poden co\l.locar al llarg d'una línia de cultiu, o en entorns ferroviaris, on els sensors es poden co\l.locar al llarg de les vies. 
...
\begin{itemize}
    ...
    \item Els dispositius coneixen l'interval de temps entre transmissions. Un cop transcorregut aquest temps, el dispositiu inicia una nova transmissió de la seva lectura cap al \est{gateway}.
\end{itemize}

\section{Limitacions del protocol sense optimitzacions energètiques}
% Bàsicament és explicar el consum de bateria?

% En el següent apartat parlar sobre sincronització
