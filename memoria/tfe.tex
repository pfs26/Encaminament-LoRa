...
Es va considerar la possibiltiat d'utilitzar més de dos blocs, per exemple en múltiples de tres, fet que faria que les transmissions es trobessin més separades i, per tant, permetria més retransmissions sense que es superposessin amb altres enviaments. Es va descartar la opció, ja que augmentaria encara més la durada del cicle de funcionament normal, i tampoc evitaria les co\l.lisions si es produeixen més retransmissions que l'espai obtingut en afegir aquest nou bloc.
