...
% Time axis (optional)
\foreach \i in {1,...,9} {
    \draw[timeline] ($(dev1.south) + (0,-\i +0.5)$) -- ($(dev2.south) + (0,-\i +0.5)$);
}
...
\draw[timeout] ($(dev1.south)+(0,-2)$) -- ++(-0.5,0) node[left] {\small{\acro{tout ack}}};

% Second message (fails)
\draw[msg] ($(dev1.south)+(0,-2.5)$) -- ($(dev2.south)+(0,-3)$) node[midway, above] {\tiny{Trama 2}};
\draw[timeout] ($(dev1.south)+(0,-4)$) -- ++(-0.5,0) node[left] {\small{\acro{tout} 2}};

% Retransmit message
\draw[msg] ($(dev1.south)+(0,-4)$) -- ($(dev2.south)+(0,-4.5)$) node[midway, above] {\tiny{Trama 2 (reintent)}};
...
\draw[msg] ($(dev1.south)+(0,-1.5)$) -- ($(dev2.south)+(0,-2)$) node[midway, above] {\tiny{Trama 1 (reintent 1)}};
\draw[timeout] ($(dev1.south)+(0,-2.5)$) -- ++(-0.5,0) node[left] {\small{\acro{tout ack}}};
\draw[msg] ($(dev1.south)+(0,-2.5)$) -- ($(dev2.south)+(0,-3)$) node[midway, above] {\tiny{Trama 1 (reintent 2)}};
\draw[timeout] ($(dev1.south)+(0,-3.5)$) -- ++(-0.5,0) node[left] {\small{\acro{tout ack}}};
\draw[msg] ($(dev1.south)+(0,-3.5)$) -- ($(dev2.south)+(0,-4)$) node[midway, above] {\tiny{Trama 1 (reintent 3)}};
\draw[timeout] ($(dev1.south)+(0,-4.5)$) -- ++(-0.5,0) node[left] {\small{\acro{tout ack}}};

\node[right] at ($(dev1.south)+(0,-4.5)$) {\tiny{Trama 1 - Fallada}};
