...
\begin{itemize}
    ...
    \item \emph{Queue}. Verifica l'estat de la cua de transmissió. Si es troba buida, torna a estat \emph{idle}. En cas contrari, si el canal es troba lliure inicia la transmissió, i si no aplica \acro{beb}.
\end{itemize}
