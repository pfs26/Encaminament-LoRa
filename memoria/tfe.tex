...
En els següents apartats es presenten diferents mecanismes de sincronització externa considerats.
% PARLAR DE SINCRONITZACIÓ INICIAL

\subsection{Sincronització explícita}
Com a sincronització explícita es considera l'ús d'un missatge especial i diferent de la resta
