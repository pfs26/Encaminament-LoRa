...
\end{tabular}
    ...
    \caption{Sincronització explícita. Transmissió dades en blocs senars/parells.}
...
\begin{enumerate}
    ...
    \item No considera la possibilitat que una transmissió pugui fallar, resultant en retransmissions. A causa de 
\end{enumerate}


\subsubsection{Altres opcions}
Durant el disseny dels anteriors mecanismes de sincronització, s'han considerat altres opcions, com ara la de utilitzar el node central com a referència, i que aquest generi un missatge de sincronització per els seus dos veïns.
