...
\resizebox{\linewidth}{!}{%
\begin{tabular}{!{\vrule width \heavyrulewidth}l!{\vrule width \heavyrulewidth}c!{\color[rgb]{0.451,0.804,0.443}\vrule width \heavyrulewidth}c|c|c|c|cccc!{\color[rgb]{0.451,0.804,0.443}\vrule width \heavyrulewidth}c|c!{\vrule width \heavyrulewidth}} \toprule
...
Així, en qualsevol dels casos, aquesta solució implica una complexitat molt major, ja que és necessari establir el temps d'inici de les transmissions de cada dispositiu. Segeuxi una lògica semblant a \acro{tdma} (\emph{Time Division Multiple Access}), on l'accés al medi es divideix en ranures de temps. A la \autoref{fig:app_opcioSyncExp2} es representa aquest comportament, on cal recordar que \fitx{D1} ara és qui té capacitats LoRaWAN i també actua com a referència.
