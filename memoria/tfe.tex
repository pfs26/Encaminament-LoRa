...
En mode actiu, el dispositiu té un consum d'aproximadament \SI{80}{\milli\ampere}. En mode de baix consum, en canvi, aquest es redueix fins a aproximadament \SI{13}{\milli\ampere}. És important tenir en compte que la placa de desenvolupament conté un \acro{led} vermell, el qual sempre es troba actiu, i presenta un consum afegit. En qualsevol dels casos, es pot observar com efectivament el consum s'ha vist reduït.

Amb aquests resultats, es verifica com l'aplicació de baix consum ha reduït el consum en un $\frac{80-13}{80}\cdot100=83.75\%$. 

% veure quin es el consum en mode actiu. Multiplicar per 5 minuts.
% veure consum en mode de baix consum, comentar que hi ha el LED sempre actiu, i multiplicar pel temps de baix consum real, sumarli el temps actiu pel consum en mode actiu. Comparar ambdós.
...
Tot i això, les proves realitzades ---amb temps de cicle reduïts--- han demostrat que l'aplicació proposada aconsegueix reduir el consum energètic dels dispositius en més d'un 80\% respecte d'un sistema sense aquesta optimització.
