...
No obstant això, encara hi ha un fet crític: què passa si la capa d'accés al medi ha de realitzar retransmissions? En aquest cas, i ja que s'ha dissenyat per tal que el temps d'espera sigui mínim, una retransmissió d'un missatge de sincronització provocaria co\l.lisions.

% // TODO: REPRESENTAR COL·LISIO AMB UN EXEMPLE PETITO???
